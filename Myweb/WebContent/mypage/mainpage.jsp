	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="myNavbar">
	      <ul class="nav navbar-nav navbar-right">
	        ...
	        <li><a href="#">로그인</a></li>
	        <li><a href="./../mypage/more03.jsp">회원가입</a></li>	          
	       <li class="dropdown">
	          <a class="dropdown-toggle" data-toggle="dropdown" href="#">MORE
	          <span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="./../mypage/pop.jsp" onclick="window.open('./../mypage/pop.jsp','new','scrollbars=yes,resizable=no,width=1200, height=800, left=0,top=0');return false">사용법</a></li>
	            <li><a href="./../mypage/more01.jsp">중고피규어</a></li>
	        	<li><a href="./../mypage/more2.jsp">자작피규어</a></li>
	            <li><a href="./../mypage/more3.jsp">게시판</a></li>
	            <li><a href="#">고객센터</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="./../images/메인사진1.jpg" alt="메인 사진1" width="1100" height="550">
      ...
      <div class="item">
        <img src="./../images/메인사진2.jpg" alt="메인사진2" width="1100" height="550">
        <div class="carousel-caption">
          <h3>나만의 삼점</h3>
      ...
      <div class="item">
        <img src="./../images/메인사진3.jpg" alt="메인 사진3" width="1100" height="550">
        <div class="carousel-caption">
  ...
  <div class="row">
	    <div class="col-sm-4">
	      ...
	      <a href="#demo" data-toggle="collapse">
	        <img src="./../images/서브사진2.jpg" class="img-circle person" alt="Random Name" width="80" height="80">
	      </a>
	    ...
	    <div class="col-sm-4">
	      ...
	      <a href="#demo2" data-toggle="collapse">
	        <img src="./../images/서브사진3.jpg" class="img-circle person" alt="Random Name" width="80" height="80">
	      </a>
	    ...
	    <div class="col-sm-4">
	      ...
	      <a href="#demo3" data-toggle="collapse">
	        <img src="./../images/서브사진4.jpg" class="img-circle person" alt="Random Name" width="80" height="80">
	      </a>
...
<div class="row text-center">
     <div class="col-sm-4">
        <div class="thumbnail">
          <img src="./../images/프로필1.jpg" alt="Paris" width="400" height="300">
    ...
    <div class="col-sm-4">
        <div class="thumbnail">
          <img src="./../images/프로필2.jpg" alt="New York" width="400" height="300">
          <p><strong>프로필</strong></p>
          <p>닉네임:오라하르콘</p>
    ...
    <div class="col-sm-4">
        <div class="thumbnail">
          <img src="./../images/프로필3.jpg" alt="San Francisco" width="400" height="300">
          <p><strong>프로필</strong></p>
